...
def test_get_post_detail_not_found():
    response = client.get('/post/detail/99999')
    assert response.status_code == status.HTTP_200_OK
...
def test_update_post_status_not_found():
    response = client.get('/post/status/99999?status=published')
    assert response.status_code == status.HTTP_404_NOT_FOUND
...
def test_delete_post_not_found():
    response = client.get('/post/delete/99999')
    assert response.status_code == status.HTTP_200_OK
